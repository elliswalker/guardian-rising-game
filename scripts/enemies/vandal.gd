...
const TEX_STAND := preload("res://assets/sprites/enemies/fallen/vandal_right.png")
# real mid-stride frame (#50) — 2-frame Kingdom walk
const TEX_WALK  := preload("res://assets/sprites/enemies/fallen/vandal_walk_right.png")
